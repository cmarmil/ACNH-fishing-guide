  ...
  <div class="modal">
      ...
      <div class="modal_content">
        <div class="modal-header">
          ...
          <img class="modal-fish-image" src="${fishInfo.critterpediaImage}">
        </div>
        <div class="wave-top"></div>
        <div class="modal-description">
          <p>
           ${fishInfo.description[0]}
          </p>
          ...
          <div class="flex-container">
            ...
            <p>Months Available: ${fishInfo.hemispheres[activeHemisphere].months[0]}</p>
          </div>
            <div class="flex-container">
              ...
              <p>Times Available: ${fishInfo.hemispheres[activeHemisphere].time[0]}</p>
            </div>
          </div>
          <div class="flex-container">
            ...
            <p class="catch-difficulty">Catch Difficulty: ${fishInfo.catchDifficulty}</p>
          </div>
        </div>
...
document.addEventListener("keydown", (e) => {
  ...
  //trap tab focus in modal untill closed.
  if (e.key === "Tab") {
